...
<body>
  ...
  <div class="body">
		...
		if(ex=='http://localhost/project%20DROPDATBASE/create_user.php?')
		{
			document.write('User succesfully created!');
			var xmlhttp = XMLHttpRequest();


		}
		else if(ex=='http://localhost/project%20DROPDATBASE/login_form.php?')
		{
		...
		<!-- <div top="50px"; left="50px";>
			<a href="create_user.php">New user? Click here!</a>
			</div> -->
